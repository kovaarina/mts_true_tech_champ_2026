...
Важно: сборка идёт **внутри лимита времени** прогона. Если `colcon build` тяжёлый (C++), он может съесть бюджет — держите пакет лёгким или напишите нам, соберём воркспейс заранее вне таймера.
